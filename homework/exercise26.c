...
int main() {
  ...
  for(i = 0; i < times; i++){
    ...
    if(strcmp(category, "add") == 0){
      ...
      scanf("%d" ,&val1);
      root = insert(root, val1, 0);

    } else if(strcmp(category, "remove") == 0){

      scanf("%d" ,&val1);
      root = delete(root, val1);

    } else if(strcmp(category, "range-search") == 0){
      
      scanf("%d %d" ,&val1 ,&val2);
      find_and_print_range(root, val1, val2, false);
    }
  ...
  //find_and_print(root, 15, false);
  //find_and_print_range(root, 4, 30, false);
  //root = delete (root, 5);
